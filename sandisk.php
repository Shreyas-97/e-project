				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.sandisk_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.sandisk_id+"</td>";
                           
                            //table_content+="<td>"+value.sandisk_brand+"</td>";
                            table_content+="<td>"+value.sandisk_desc+"</td>";
                            table_content+="<td>"+value.sandisk_price+"</td>";
                            table_content+="<td>"+value.sandisk_name+"</td>";
                            table_content+="<td>"+value.sandisk_img+"</td>";
