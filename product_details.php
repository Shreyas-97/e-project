...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="dell1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="dell1.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="themes/images/products/add5.jpg"> <img style="width:29%" src="themes/images/products/add5.jpg" alt=""/></a>
                   <a href="themes/images/products/add5.jpg"> <img style="width:29%" src="themes/images/products/add5.jpg" alt=""/></a>
                   <a href="themes/images/products/add5.jpg" > <img style="width:29%" src="themes/images/products/add5.jpg" alt=""/></a>
                  </div>
                  <div class="item">
                   <a href="themes/images/products/sh1.jpg" > <img style="width:29%" src="themes/images/products/sh1.jpg" alt=""/></a>
                   <a href="themes/images/products/sh1.jpg"> <img style="width:29%" src="themes/images/products/sh1.jpg" alt=""/></a>
                   <a href="themes/images/products/sh1.jpg"> <img style="width:29%" src="themes/images/products/sh1.jpg" alt=""/></a>
                  </div>
                </div>
		...
		<div class="tab-content">
			<div class="tab-pane" id="listView">
				<div class="row">	  
					<div class="span2">
						<img src="themes/images/products/add6.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
						<img src="themes/images/products/add1.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="themes/images/products/add2.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="themes/images/products/.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="row">	  
					<div class="span2">
					<img src="themes/images/products/add4.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<hr class="soft"/>
				<div class="row">	  
					<div class="span2">
					<img src="themes/images/products/a1.jpg" alt=""/>
					</div>
					<div class="span4">
						<h3>New | Available</h3>				
						<hr class="soft"/>
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="themes/images/products/a2.jpg" alt=""/></a>
						<div class="caption">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="themes/images/products/a3.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="themes/images/products/a1.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="themes/images/products/add6.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
