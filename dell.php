				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.dell_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.dell_id+"</td>";
                           
                           // table_content+="<td>"+value.dell_brand+"</td>";
                            table_content+="<td>"+value.dell_desc+"</td>";
                            table_content+="<td>"+value.dell_price+"</td>";
                            table_content+="<td>"+value.dell_name+"</td>";
                            table_content+="<td>"+value.dell_img+"</td>";
