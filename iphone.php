				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.iphone_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.iphone_id+"</td>";
                           
                            //table_content+="<td>"+value.iphone_brand+"</td>";
                            table_content+="<td>"+value.iphone_desc+"</td>";
                            table_content+="<td>"+value.iphone_price+"</td>";
                            table_content+="<td>"+value.iphone_name+"</td>";
                            table_content+="<td>"+value.iphone_img+"</td>";
