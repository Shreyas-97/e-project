				...
				success:function(response){
					...
					var obj=JSON.parse(response);
                        ...
                        $.each(obj,function(index,value){
                        	alert(value.puma_id)
                            table_content+="<tr>";
                            table_content+="<td>"+value.puma_id+"</td>";
                           
                            //table_content+="<td>"+value.puma_brand+"</td>";
                            table_content+="<td>"+value.puma_desc+"</td>";
                            table_content+="<td>"+value.puma_price+"</td>";
                            table_content+="<td>"+value.puma_name+"</td>";
                            table_content+="<td>"+value.puma_img+"</td>";
